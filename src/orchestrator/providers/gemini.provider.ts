...
const SYSTEM_SUFFIX =
  ...
  "Defina 'action' como 'hangup' apenas se a conversa terminou ou se for para desligar o telefone. Caso contrário, use 'speak'. Certifique-se de retornar APENAS o JSON, sem markdown ou explicações fora do JSON.";
      ...
      const chatSession = model.startChat({
        ...
        generationConfig: {
          ...
          responseSchema: {
            ...
            properties: {
              text: { type: SchemaType.STRING, description: 'A resposta de texto do assistente para o usuário.' },
              action: {
                type: SchemaType.STRING,
                enum: ['speak', 'hangup'],
                description: "Ação a ser executada. 'speak' para continuar a conversa, 'hangup' para desligar.",
              },
            },
